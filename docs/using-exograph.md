...
Hover over a bullet or task with nested items to reveal its fold arrow. Each nesting level folds independently, and vertical guides show the items inside that section. Folding changes the view without changing the Markdown.
